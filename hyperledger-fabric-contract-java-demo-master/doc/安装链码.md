...
```
peer lifecycle chaincode package parkingChainCode.tar.gz --path ../chaincode/parkingChainCode/ --lang java --label parkingChainCode
```
...
```
peer lifecycle chaincode install parkingChainCode.tar.gz
```
...
```
export CC_PACKAGE_ID=export CC_PACKAGE_ID=hyperledger-fabric-contract-java-demo:b4dd14c2b1becd98955a7701ad47e0238dfd554f31e28fb81142b75db20884d0
```
